...
class Sportscenterform extends Controller {

    public function index() {
        $this->view('external/sportscenterform');
    }
    ...
    public function getPrice() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $courtid = 23; // Use the correct courtid for badminton
    ...
    public function checkAvailability() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $date = $_POST['date'];
            $courtid = 23; // Use the correct court ID for badminton
    ...
    public function reserve() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($result) {
                ...
                header("Location: " . ROOT . "/external/sportscenterform");
                exit;
            } else {
