...
class Karateform extends Controller {

    public function index() {
        $this->view('external/karateform');
    }
    ...
    public function getPrice() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $courtid = 21; // Use the correct courtid for badminton
    ...
    public function checkAvailability() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $date = $_POST['date'];
            $courtid = 21; // Use the correct court ID for badminton
    ...
    public function reserve() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($result) {
                ...
                header("Location: " . ROOT . "/external/karateform");
                exit;
            } else {
