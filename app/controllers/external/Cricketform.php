<?php
class Cricketform extends Controller {
    public function index() {
        // This will load the hockey form view
        $this->view('external/cricketform');
    }
    ...
    public function reserve() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($result) {
                ...
                header("Location: " . ROOT . "/external/cricketform"); // or your correct form page route
