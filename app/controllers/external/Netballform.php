<?php
class Netballform extends Controller {
    public function index() {
        // This will load the hockey form view
        $this->view('external/netballform');
    }
    ...
    public function getPrice() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $description ="2"; // Get the 'court markings' value (Yes or No)
            $courtid = 31; // Hockey court id
    ...
    public function reserve() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($result) {
                ...
                header("Location: " . ROOT . "/external/netballform"); // or your correct form page route
