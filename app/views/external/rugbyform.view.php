...
<html lang="en">
    ...
    ?>
        ...
        <h1 class="title1">Rugby field Reservation</h1>
        ...
        <div class="rules">
            ...
            <input type="hidden" name="court_name" value="rugby">
...
function checkAvailability() {
    ...
    formData.append('court_name', 'rugby');
    
    // Send request
    const xhr = new XMLHttpRequest();
    xhr.open('POST', '<?=ROOT?>/external/rugbyform/checkFullDayAvailability', true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
...
function checkHalfDayAvailability(date) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', '<?=ROOT?>/external/rugbyform/checkHalfDayAvailability', true);
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
