...
<head>
    ...
    <title>Indoor Reservations</title>
    ...
    <style>
        ...
        /* Style the duration dropdown for better visibility */
        #duration {
            font-weight: bold;
        }
...
<body>
    ...
    <?php $current_page = 'indoor_reservation'; include 'sidebar.view.php';?>
    ...
    <div class="main-content">
        <div class="header">
            <h1>Indoor Court Reservations</h1>
        ...
        <div class="container">
            ...
            <div class="action-buttons">
                <button class="button" onclick="window.location.href='indoor_requests';">Requests</button>
            ...
            <div class="time-slots-container" id="time-slots">
                <h2 id="availability-date">Indoor Court Availability</h2>
                ...
                <div class="time-slots-content" id="slots-container">
                    <?php 
                        $processed = []; // keep track of processed slots
    ...
    <div id="reservationModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Make a New Indoor Court Reservation</h2>
                <span class="close" onclick="closeModal('reservationModal')">&times;</span>
            </div>
            <div class="modal-body">
                <form id="newReservationForm" method="POST" action="indoor_reservation/saveReservation">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group half">
                            ...
                            <select id="duration" name="duration" required>
                                ...
                                <option value="half">Half Day (8am-1pm or 1pm-6pm)</option>
                                <option value="full">Full Day (8am-6pm)</option>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateDisplayDate() {
            ...
            availabilityDate.textContent = `Indoor Court Availability for ${displayDate}`;
        }
        ...
        function updateDurationOptions(startTime) {
            ...
            if (startTime === "08:00:00") {
                ...
                addDurationOption(durationSelect, "1 hour", "1 Hour");
                addDurationOption(durationSelect, "half", "Half Day (8am-1pm)");
                addDurationOption(durationSelect, "full", "Full Day (8am-6pm)");
            } 
            else if (startTime === "13:00:00") {
                // For 1:00 PM, add 1 hour and half day options
                addDurationOption(durationSelect, "1 hour", "1 Hour");
                addDurationOption(durationSelect, "half", "Half Day (1pm-6pm)");
            }
            else {
                // For all other times, only 1 hour option
                addDurationOption(durationSelect, "1 hour", "1 Hour");
            }
        }
...
function openModal() {
    ...
    function cancelReservation(reservationid){
        ...
        if (confirm("Are you sure you want to cancel this reservation?")) {
            window.location.href = "indoor_reservation/cancelReservation/" + reservationid;
        }
    }
