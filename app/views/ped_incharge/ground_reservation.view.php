...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="calendar-container-2">
                ...
                <div class="day-column">
                    <!-- Day view with hourly slots -->
                    <div class="day">Hockey Court</div>
                ...
                <div class="day-column">
                    <!-- Day view with hourly slots -->
                    <div class="day">Cricket Pitch</div>
                    <div class="time-slot"></div>
                    <div class="time-slot"></div>
                    <div class="time-slot"></div>
                    <div class="time-slot"></div>
                ...
                <div class="day-column">
                    <!-- Day view with hourly slots -->
                    <div class="day">Rugger court</div>
                    <div class="time-slot"></div>
                    <div class="time-slot"></div>
                    <div class="time-slot"></div>
                    <div class="time-slot"></div>
        ...
        <div id="reservationDetailsModal" class="reservation-details">
